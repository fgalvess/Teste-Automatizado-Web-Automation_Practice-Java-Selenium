...
public class ComprasSteps {
	...
	/*OBS: O código da erro ao tentar rodar com a versão atual do chrome (103)
	 * e ao pesquisar descobri que é bug da nova versão do chrome com o selenium 
	 * e a unica solução que achei foi rodar meus testes na versão anterior do chrome (102)
	*/
	...
	public void oSistemaExibeOCarrinhoComApenasUmProduto() {
		assertEquals("1", driver.findElement(By.xpath("//a[@title=\"View my shopping cart\"]/span[text()=\"1\"]")).getText());
	}
